      ...
      <section className="contact" id="contact">
        ...
        <div className="contact-list">
            ...
            <div className="contact-icons">
                <a href="https://www.facebook.com/profile.php?id=100064764007563"><i className='bx bxl-facebook-circle'></i></a>
                <a href="https://web.whatsapp.com/"><i className='bx bxl-whatsapp'></i></a>
                <a href="https://mail.google.com/mail/u/0/?hl=en_GB#inbox"><i className='bx bxl-gmail' ></i></a>
